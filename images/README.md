# Drop display / device photos here

Suggested files (referenced from the root README):

| File | Purpose |
| --- | --- |
| `display.jpg` | Primary shot of the e-ink UI running this config (battery %, layout) |
